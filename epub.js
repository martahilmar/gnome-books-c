...
EPUBJS.Book.prototype.loadPackage = function(_containerPath){
	...
	if(!this.settings.packageUrl) { //-- provide the packageUrl to skip this step
        ...
        console.log("this.settings.packageUrl: " + paths.packagePath);
...
EPUBJS.Book.prototype.unpack = function(packageXml){
    ...
    console.log("book.contents.navPath: " + book.settings.navUrl);
    ...
    console.log("book.contents.tocPath");
...
EPUBJS.Book.prototype.loadXml = function(url){
  console.log("EPUBJS.core.request: " + url);
...
EPUBJS.Book.prototype.preloadNextChapter = function() {
	...
	if(next) {
    console.log("EPUBJS.preloadNextChapter: " + next.absolute);
		EPUBJS.core.request(next.absolute, 'xml', this.settings.withCredentials);
	}
};
...
EPUBJS.Chapter.prototype.contents = function(_store){
  ...
  console.log("EPUBJS.core.request -> prototype: " + url);
...
EPUBJS.core.request = function(url, type, withCredentials) {
  ...
  console.log('Hey this is my url,' + 'sneaky:epub/'+url + ' type: ' + type);
	...
	function handler() {
      ...
      console.log("Status: " + this.status + " Response: " + this.responseXML);
