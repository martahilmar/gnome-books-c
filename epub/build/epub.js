...
EPUBJS.Book.prototype.urlFrom = function(bookPath){
  var uri = EPUBJS.core.uri(bookPath),
    ...
    base;
    // http://localhost:8080/examples/single.html
    console.log("----------- location: " + location + " absolute: " + absolute + " root: " + fromRoot);
...
EPUBJS.Render.Iframe = function() {
  ...
  this.document = null;
  this.window = null;
  //this.window = window.location.assign('sneaky:examples/single.html');
  this.docEl = null;
  this.bodyEl = null;
...
EPUBJS.Render.Iframe.prototype.loaded = function(v){
  ...
  //var url = 'snekay:reader/moby-dick/OPS/cover.xhtml';
